...
/**
 * \class	DataReader
 * \brief	The DataReader is able to read the input and construct the appropriate bifiltration.
 */
...
//now the DataReader class
class DataReader {
public:
    DataReader(InputParameters& input_params);
