...
public:
    ...
    void draw_barcode(Barcode const &bc, double zero_coord, bool show); //draws the barcode parallel to the slice line; "show" determines whether or not bars are visible
    void update_barcode(Barcode const &bc, double zero_coord, bool show); //updates the barcode (e.g. after a change in the slice line)
