...
int main(int argc, char* argv[])
{
    ...
    QCommandLineOption noGUIOption(QStringList() << "n"
                                                 << "no-gui",
        QCoreApplication::translate("main", "Run RIVET in the console, without a graphical interface."));
    parser.addOption(noGUIOption);

    QCommandLineOption homOption(QStringList() << "H"
                                               << "homology",
        QCoreApplication::translate("main", "Dimension of homology to compute."), QCoreApplication::translate("main", "dimension"), "0");
    parser.addOption(homOption);

    QCommandLineOption outputOption(QStringList() << "o"
                                                  << "output",
        QCoreApplication::translate("main", "Output file where augmented arrangement will be saved."), QCoreApplication::translate("main", "filename"), "");
    ...
    QCommandLineOption xbinOption(QStringList() << "x"
                                                << "xbins",
        QCoreApplication::translate("main", "Number of bins in the x-direction."), QCoreApplication::translate("main", "integer"), "0");
    parser.addOption(xbinOption);

    QCommandLineOption ybinOption(QStringList() << "y"
                                                << "ybins",
        QCoreApplication::translate("main", "Number of bins in the y-direction."), QCoreApplication::translate("main", "integer"), "0");
