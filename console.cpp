...
int main(int argc, char* argv[])
{
    ...
    params.outputFormat = args["--format"].asString();
    ...
    bool function = args["--function"].isBool() && args["--function"].asBool();
    bool x_reverse = args["--x-reverse"].isBool() && args["--x-reverse"].asBool();
    bool y_reverse = args["--y-reverse"].isBool() && args["--y-reverse"].asBool();
    ...
    if (type) {
        ...
        if (str != "csv-points" && str != "points" && str != "metric" && str != "bifiltration" && str != "firep" && str != "RIVET_msgpack")
    ...
    params.x_reverse = x_reverse;
    params.y_reverse = y_reverse;
