...
.. figure:: images/flowchart.pdf  
    ...
    The RIVET pipeline.  Green items can be input directly to RIVET via a file.  Yellow items can be printed to the console.  Items with red boundary are saved in a file called the *module invariants  file*, which serves as input to RIVET’s visualization.
